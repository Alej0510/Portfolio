import { A as AstroError, x as MissingSharp } from './entrypoint_BqKIaYMu.mjs';
import { b as baseService, p as parseQuality } from './generic_DdTJTulM.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_DkZ1cQ_S.mjs').then(n => n.i)).default;
  } catch {
